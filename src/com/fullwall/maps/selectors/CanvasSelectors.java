...
public class CanvasSelectors {
    ...
    public static class BoxSelector implements CanvasSelector {
        ...
        private static class BoxSelectedArea implements SelectedArea {
            ...
            private BoxSelectedArea(byte[] pixels, int width, int height, int x, int y) {
            ...
            private byte[] scale(byte[] data, double scale) {
                ...
                try {
                    ...
                    Image scaledImage = img.getScaledInstance((int) (width * scale), (int) (height * scale),
                            Image.SCALE_SMOOTH);
                    BufferedImage imageBuff = new BufferedImage((int) (width * scale),
            ...
            public SelectedArea scale(double scale) {
                return new BoxSelectedArea(scale(selected, scale), (int) (width * scale),
                        (int) (height * scale), x, y);
            }

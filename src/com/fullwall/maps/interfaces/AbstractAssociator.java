...
public abstract class AbstractAssociator<A> implements Associator<A> {
    private final SetMultimap<Associatable<A>, A> associations = HashMultimap.create();
    private final SetMultimap<Class<? extends Associatable<A>>, A> classAssociations = HashMultimap.create();
    ...
    @Override
    public void associate(Class<? extends Associatable<A>> associated, A association) {
    ...
    @Override
    public Collection<A> getAssociations(Class<? extends Associatable<A>> association) {
